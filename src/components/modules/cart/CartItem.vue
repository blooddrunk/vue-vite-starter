<template>
  <CartItemSkeleton v-if="loading"></CartItemSkeleton>
  <van-swipe-cell v-else>
    <div
      class="tw-p-2 tw-mt-3 tw-bg-white tw-rounded-md tw-shadow tw-shadow-light tw-flex tw-items-center"
    >
      <van-checkbox
        v-if="!readonly"
        v-model="__checked"
      ...
      <div class="tw-flex-grow tw-grid tw-grid-cols-7 tw-items-center tw-gap-3">
        <van-image
